...
export default {
  ...
  methods: {
    ...
    getRoomUrl(isTestRoom) {
      ...
      let query = {...this.form}
      delete query.roomId
      query.imgTransformer = window.localStorage.imgTransformerV2 == null ? '[{"from":"(真不是人)","target":"test1.jpg"}, {"from":"(悠亚画画)","target":"test2.jpg"}]' : window.localStorage.imgTransformerV2
      let resolved
      if (isTestRoom) {
